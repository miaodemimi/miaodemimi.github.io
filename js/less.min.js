...
!(function (e, t) {
  ...
  function t(e, t) {
    if (t)
      for (var n in t.dataset)
        if (Object.prototype.hasOwnProperty.call(t.dataset, n))
          if (
            "env" === n ||
            "dumpLineNumbers" === n ||
            "rootpath" === n ||
      ...
      function e(e, t) {
        ...
        for (
          ...
          a
            ...
            : r < n.length &&
              this.warn(
                "missing required function in environment - ".concat(s),
              );
        }
      }
      return (
        (e.prototype.getFileManager = function (e, t, n, i, s) {
          (e ||
            r.warn(
          ...
          n.pluginManager &&
            (a = [].concat(a).concat(n.pluginManager.getFileManagers()));
          for (var o = a.length - 1; o >= 0; o--) {
            var l = a[o];
            if (l[s ? "supportsSync" : "supports"](e, t, n, i)) return l;
          }
          return null;
        }),
    ...
    u = (function () {
      ...
      return (
        ...
        (e.compare = function (t, n) {
          if (t.compare && "Quoted" !== n.type && "Anonymous" !== n.type)
            return t.compare(n);
          if (n.compare) return -n.compare(t);
          if (t.type === n.type) {
            if (((t = t.value), (n = n.value), !Array.isArray(t)))
              return t === n ? 0 : void 0;
            if (t.length === n.length) {
              for (var i = 0; i < t.length; i++)
                if (0 !== e.compare(t[i], n[i])) return;
              return 0;
            }
          }
        }),
        ...
        : e.length >= 6
          ? ((this.rgb = []),
            e.match(/.{2}/g).map(function (e, t) {
              t < 3
                ? i.rgb.push(parseInt(e, 16))
                : (i.alpha = parseInt(e, 16) / 255);
            }))
          : ((this.rgb = []),
            e.split("").map(function (e, t) {
              t < 3
                ? i.rgb.push(parseInt(e + e, 16))
                : (i.alpha = parseInt(e + e, 16) / 255);
            })),
  ...
  ((c.prototype = Object.assign(new u(), {
      ...
      switch (r) {
        ...
        case "hsl":
          ((n = this.toHSL()),
            (a = [
              this.fround(e, n.h),
              "".concat(this.fround(e, 100 * n.s), "%"),
              "".concat(this.fround(e, 100 * n.l), "%"),
            ].concat(a)));
      }
      if (r)
        return "".concat(r, "(").concat(a.join(",".concat(s ? "" : " ")), ")");
      if (((n = this.toRGB()), s)) {
        var o = n.split("");
        o[1] === o[2] &&
          o[3] === o[4] &&
          o[5] === o[6] &&
          (n = "#".concat(o[1]).concat(o[3]).concat(o[5]));
      }
      return n;
    },
    operate: function (e, t, n) {
      for (
        var i = new Array(3), r = this.alpha * (1 - n.alpha) + n.alpha, s = 0;
        s < 3;
        s++
      )
        i[s] = this._operate(e, t, this.rgb[s], n.rgb[s]);
      return new c(i, r);
    },
    toRGB: function () {
      return f(this.rgb);
    ...
    toHSL: function () {
      ...
      if (a === o) e = t = 0;
        ...
        switch (((t = l > 0.5 ? u / (2 - a - o) : u / (a + o)), a)) {
          case n:
            e = (i - r) / u + (i < r ? 6 : 0);
            break;
          case i:
  ...
  v.prototype = Object.assign(new u(), {
    type: "Paren",
    genCSS: function (e, t) {
      (t.add("("), this.value.genCSS(e, t), t.add(")"));
    },
    eval: function (e) {
      return new v(this.value.eval(e));
    },
  });
  var d = { "": !0, " ": !0, "|": !0 },
    m = function (e) {
  ...
  g.prototype = Object.assign(new u(), {
    type: "Element",
    accept: function (e) {
      var t = this.value;
  ...
  var y = { ALWAYS: 0, PARENS_DIVISION: 1, PARENS: 2 },
    b = 0,
    w = 1,
    x = 2;
  function S(e) {
  ...
  function C(e, t = {}) {
    ...
    return [
      ...
      if (I(t.props) && !t.props.includes(i)) return n;
      return (
        (function (e, t, n, i, r) {
          const s = {}.propertyIsEnumerable.call(i, t)
            ? "enumerable"
            : "nonenumerable";
          ("enumerable" === s && (e[t] = n),
            r &&
  ...
  ((V.prototype.constructor = V),
    (V.prototype.toString = function (e) {
      var t;
      e = e || {};
      var n = (null !== (t = this.type) && void 0 !== t ? t : "")
          .toLowerCase()
          .includes("warning"),
        i = n ? this.type : "".concat(this.type, "Error"),
        r = n ? "yellow" : "red",
        s = "",
        a = this.extract || [],
        o = [],
      ...
      if (e.stylize) {
        var u = typeof e.stylize;
        if ("function" !== u)
          throw Error(
            "options.stylize should be a function, got a ".concat(u, "!"),
          );
        l = e.stylize;
      }
      if (null !== this.line) {
        if (
          (n ||
            "string" != typeof a[0] ||
            o.push(l("".concat(this.line - 1, " ").concat(a[0]), "grey")),
          "string" == typeof a[1])
        ) {
          var c = "".concat(this.line, " ");
          (a[1] &&
            (c +=
              a[1].slice(0, this.column) +
              l(
                l(
                  l(a[1].substr(this.column, 1), "bold") +
                    a[1].slice(this.column + 1),
                  "red",
                ),
                "inverse",
              )),
        ...
        (n ||
          "string" != typeof a[2] ||
          o.push(l("".concat(this.line + 1, " ").concat(a[2]), "grey")),
          (o = "".concat(o.join("\n") + l("", "reset"), "\n")));
      }
      return (
        (s += l("".concat(i, ": ").concat(this.message), r)),
        this.filename && (s += l(" in ", r) + this.filename),
        this.line &&
          (s += l(
            " on line "
        ...
        (s += "\n".concat(o)),
        this.callLine &&
          ((s += "".concat(l("from ", r) + (this.filename || ""), "/n")),
          (s += ""
            .concat(l(this.callLine, "grey"), " ")
  ...
  var N = (function () {
      ...
      return (
        (e.prototype.visit = function (e) {
          ...
          var t = e.typeIndex;
          if (!t)
            return (e.value && e.value.typeIndex && this.visit(e.value), e);
          var n,
            ...
            if (void 0 !== (r = e[i]))
              if (r.splice)
                for (a = 0, s = r.length; a < s; a++)
                  void 0 !== (o = r[a]) &&
                    (o.splice ? o.length && this.flatten(o, t) : t.push(o));
              else t.push(r);
          return t;
        }),
        e
    ...
    U = function (e, t, n) {
      if (e)
        for (var i = 0; i < n.length; i++)
          Object.prototype.hasOwnProperty.call(e, n[i]) && (t[n[i]] = e[n[i]]);
    },
    q = [
      "paths",
      "rewriteUrls",
  ...
  ((B.Eval = function (e, t) {
    ...
    (B.Eval.prototype.enterCalc = function () {
      (this.calcStack || (this.calcStack = []),
        this.calcStack.push(!0),
        (this.inCalc = !0));
    }),
    (B.Eval.prototype.exitCalc = function () {
      (this.calcStack.pop(), this.calcStack.length || (this.inCalc = !1));
    }),
    (B.Eval.prototype.inParenthesis = function () {
      (this.parensStack || (this.parensStack = []), this.parensStack.push(!0));
    }),
    (B.Eval.prototype.outOfParenthesis = function () {
      this.parensStack.pop();
    }),
    (B.Eval.prototype.inCalc = !1),
    (B.Eval.prototype.mathOn = !0),
    (B.Eval.prototype.isMathOn = function (e) {
      return (
        !!this.mathOn &&
        !!(
          "/" !== e ||
    ...
    (B.Eval.prototype.pathRequiresRewrite = function (e) {
      return (this.rewriteUrls === w ? G : z)(e);
    }),
    (B.Eval.prototype.rewritePath = function (e, t) {
      var n;
      return (
        (t = t || ""),
        (n = this.normalizePath(t + e)),
        G(e) && z(t) && !1 === G(n) && (n = "./".concat(n)),
        n
      );
    }),
    (B.Eval.prototype.normalizePath = function (e) {
      var t,
        n = e.split("/").reverse();
      for (e = []; 0 !== n.length; )
        switch ((t = n.pop())) {
  ...
  var W = (function () {
    ...
    J = function (e, t) {
      ((this._visitor = new N(this)),
        (this._importer = e),
        (this._finish = t),
        (this.context = new B.Eval()),
        (this.importCount = 0),
        (this.onceFileDetectionMap = {}),
        (this.recursionDetector = {}),
        (this._sequencer = new W(this._onSequencerEmpty.bind(this))));
    };
  J.prototype = {
    isReplacing: !1,
    run: function (e) {
    ...
    visitImport: function (e, t) {
      ...
      if (!e.css || n) {
        var i = new B.Eval(this.context, A(this.context.frames)),
          r = i.frames[0];
        (this.importCount++,
          e.isVariableImport()
    ...
    processImportNode: function (e, t, n) {
      ...
      if (!i || (i.css && !r))
        ...
        for (var s = void 0 === i.css, a = 0; a < n.rules.length; a++)
          if (n.rules[a] === e) {
            n.rules[a] = i;
            break;
          }
        ...
        this._importer.push(i.getPath(), s, i.fileInfo(), i.options, l);
      }
    },
    onImported: function (e, t, n, i, r, s) {
      n &&
        (n.filename ||
      ...
      if (
        (t.importMultiple ||
          (e.skip =
            ...
            function () {
              return (
                s in a.onceFileDetectionMap ||
                ((a.onceFileDetectionMap[s] = !0), !1)
              );
            }),
        !s && u && (e.skip = !0),
        i &&
          ...
          !o && !l && (t.importMultiple || !c)))
      ) {
        a.recursionDetector[s] = !0;
        var h = this.context;
        this.context = t;
        try {
      ...
      (a.importCount--, a.isFinished && a._sequencer.tryRun());
    },
    ...
    visitAtRule: function (e, t) {
      e.value
        ? this.context.frames.unshift(e)
        : e.declarations && e.declarations.length
          ? e.isRooted
            ? this.context.frames.unshift(e)
            : this.context.frames.unshift(e.declarations[0])
          : e.rules && e.rules.length && this.context.frames.unshift(e);
    },
        ...
        (e.prototype.visitRuleset = function (e, t) {
          if (!e.root) {
            var n,
              ...
              l = o ? o.length : 0;
            for (n = 0; n < l; n++)
              e.rules[n] instanceof He.Extend &&
                (a.push(o[n]), (e.extendOnEveryPath = !0));
            var u = e.paths;
      ...
      return (
        ...
        (e.prototype.checkExtendsForNonMatched = function (e) {
          ...
          e.filter(function (e) {
            ...
            t["".concat(e.index, " ").concat(n)] ||
              ((t["".concat(e.index, " ").concat(n)] = !0),
              r.warn("WARNING: extend '".concat(n, "' has no matches")));
          });
        }),
            ...
            for (r = 0; r < t.length; r++)
              ((l = e[i]),
                ...
                l.parent_ids.indexOf(u.object_id) >= 0 ||
                  ((o = [u.selfSelectors[0]]),
                  (s = f.findMatch(l, o)).length &&
                    ((l.hasFoundMatches = !0),
                    l.selfSelectors.forEach(function (e) {
                      var t = u.visibilityInfo();
                      ((a = f.extendSelector(s, o, e, l.isVisible())),
                        ((c = new He.Extend(
                          u.selector,
                          u.option,
                          0,
        ...
        (e.prototype.visitRuleset = function (e, t) {
          if (!e.root) {
            var n,
              ...
              r,
              s,
              a = this.allExtendsStack[this.allExtendsStack.length - 1],
              o = [],
              l = this;
            for (r = 0; r < a.length; r++)
              for (i = 0; i < e.paths.length; i++)
                if (((s = e.paths[i]), !e.extendOnEveryPath)) {
                  var u = s[s.length - 1].extendList;
                  (u && u.length) ||
                    ((n = this.findMatch(a[r], s)).length &&
                      ((a[r].hasFoundMatches = !0),
                      a[r].selfSelectors.forEach(function (e) {
                        var t;
                        ((t = l.extendSelector(n, s, e, a[r].isVisible())),
                          o.push(t));
                      })));
                }
          ...
          for (n = 0; n < t.length; n++)
            for (i = t[n], r = 0; r < i.elements.length; r++)
              for (
                ...
                ((l = c[o]),
                  "" === (a = s.combinator.value) && 0 === r && (a = " "),
                  !this.isElementValuesEqual(u[l.matched].value, s.value) ||
                  (l.matched > 0 && u[l.matched].combinator.value !== a)
                    ? (l = null)
                    : l.matched++,
                  l &&
          ...
          for (r = 0; r < e.length; r++)
            ((s = t[(o = e[r]).pathIndex]),
              ...
              u === o.pathIndex && r > 0
                ...
                : (h = h.concat(t.slice(u, o.pathIndex))).push(
                    new He.Selector(l),
                  ),
              (u = o.endPathIndex),
              (c = o.endPathElementIndex) >= t[u].elements.length &&
                ((c = 0), u++));
          return (
            u < t.length &&
              c > 0 &&
    ...
    Z = (function () {
      ...
      return (
        ...
        (e.prototype.visitAtRule = function (e, t) {
          var n = this.contexts[this.contexts.length - 1];
          e.declarations && e.declarations.length
            ? (e.declarations[0].root = 0 === n.length || n[0].multiMedia)
            : e.rules &&
              e.rules.length &&
  ...
  Y.prototype = {
    ...
    checkValidNodes: function (e, t) {
      if (e)
        for (var n = 0; n < e.length; n++) {
          var i = e[n];
          if (t && i instanceof He.Declaration && !i.variable)
            throw {
              message:
    ...
    visitRuleset: function (e, t) {
      ...
      if ((this.checkValidNodes(e.rules, e.firstRoot), e.root))
        ...
        for (var r = e.rules, s = r ? r.length : 0, a = 0; a < s; )
          (n = r[a]) && n.rules
            ? (i.push(this._visitor.visit(n)), r.splice(a, 1), s--)
            : a++;
    ...
    _removeDuplicateRules: function (e) {
      if (e) {
        ...
        for (i = e.length - 1; i >= 0; i--)
          if ((n = e[i]) instanceof He.Declaration)
            if (r[n.name]) {
              (t = r[n.name]) instanceof He.Declaration &&
    ...
    _mergeRules: function (e) {
      if (e) {
        for (var t = {}, n = [], i = 0; i < e.length; i++) {
          ...
          if (r.merge) {
            var s = r.name;
            (t[s] ? e.splice(i--, 1) : n.push((t[s] = [])), t[s].push(r));
          }
        }
        n.forEach(function (e) {
          if (e.length > 0) {
            var t = e[0],
              n = [],
              i = [new He.Expression(n)];
            (e.forEach(function (e) {
              ("+" === e.merge &&
                n.length > 0 &&
                i.push(new He.Expression((n = []))),
                n.push(e.value),
                (t.important = t.important || e.important));
            }),
              (t.value = new He.Value(i)));
          }
        });
      }
    },
  ...
  var ee = {
    Visitor: N,
    ImportVisitor: J,
    MarkVisibleSelectorsVisitor: H,
    ExtendVisitor: Q,
    JoinSelectorVisitor: Z,
    ToCSSVisitor: Y,
  };
  var te = function () {
    var e,
    ...
    function u(n) {
      ...
      if (((s = s.slice(n + l.i - d + p)), (a = l.i), !s.length)) {
    ...
    return (
      (l.save = function () {
        ((a = l.i), o.push({ current: s, i: l.i, j: t }));
      }),
      (l.restore = function (e) {
        (l.i > n || (l.i === n && e && !i)) && ((n = l.i), (i = e));
        var r = o.pop();
        ((s = r.current), (a = l.i = r.i), (t = r.j));
      }),
      (l.forget = function () {
        o.pop();
      }),
      ...
      (l.$quoted = function (t) {
        var n = t || l.i,
          i = e.charAt(n);
        if ("'" === i || '"' === i) {
          for (var r = e.length, s = n, a = 1; a + s < r; a++) {
            switch (e.charAt(a + s)) {
              case "\\":
                a++;
                continue;
              ...
              case "\n":
                break;
              case i:
                var o = e.substr(s, a + 1);
                return t || 0 === t ? [i, o] : (u(a + 1), o);
            }
          }
          return null;
        }
          ...
          (r = o
            ? (function (e, t) {
                ...
                function m(t) {
                  ...
                  (n < 512 && !t) ||
                    !n ||
                    (v.push(e.slice(d, a + 1)), (d = a + 1));
                }
                for (a = 0; a < h; a++)
                  if (!(((l = e.charCodeAt(a)) >= 97 && l <= 122) || l < 34))
                    switch (l) {
                      case 40:
                        (p++, (i = a));
                        continue;
                      ...
                      case 39:
                      case 96:
                        for (c = 0, o = a, a += 1; a < h; a++)
                          if (!((u = e.charCodeAt(a)) > 96)) {
                            if (u == l) {
                              c = 1;
                              break;
                            }
                            if (92 == u) {
                              if (a == h - 1) return t("unescaped `\\`", a);
                              a++;
                            }
                          }
                        if (c) continue;
                        return t(
                          "unmatched `".concat(String.fromCharCode(l), "`"),
                          o,
                        );
                      case 47:
                        if (p || a == h - 1) continue;
                        if (47 == (u = e.charCodeAt(a + 1)))
                          for (
                            a += 2;
                            a < h &&
                            (!((u = e.charCodeAt(a)) <= 13) ||
                          ...
                          for (
                            r = o = a, a += 2;
                            a < h - 1 &&
                            (125 == (u = e.charCodeAt(a)) && (s = a),
                            42 != u || 47 != e.charCodeAt(a + 1));
                            a++
                          );
                          if (a == h - 1) return t("missing closing `*/`", o);
                          a++;
                        }
                        continue;
                      case 42:
                        if (a < h - 1 && 47 == e.charCodeAt(a + 1))
                          return t("unmatched `/*`", a);
                        continue;
                    }
                return 0 !== f
                  ? t(
  ...
  var ae = function e(t, n, i, s) {
          ...
          new V(
            {
              index: null != s ? s : o.i,
              filename: i.filename,
              type: a ? "".concat(a.toUpperCase(), " WARNING") : "WARNING",
              message: e,
            },
            n,
          ).toString(),
    ...
    function c(e, t) {
      var n = e instanceof Function ? e.call(a) : o.$re(e);
      if (n) return n;
      l(
        t ||
          ("string" == typeof e
            ? "expected '".concat(e, "' got '").concat(o.currentChar(), "'")
            : "unexpected token"),
      );
    }
    function h(e, t) {
      if (o.$char(e)) return e;
      l(t || "expected '".concat(e, "' got '").concat(o.currentChar(), "'"));
    }
    function f(e) {
      var t = i.filename;
      return { lineNumber: k(e, o.getInput()).line + 1, fileName: t };
    }
    return {
      parserInput: o,
      imports: n,
      ...
      parseNode: function (e, t, r) {
        ...
        try {
          c.start(e, !1, function (e, t) {
            r({ message: e, index: t + s });
          });
          for (var h = 0, f = void 0; (f = t[h]); h++)
            ((l = a[f]()), u.push(l || null));
          c.end().isFinished ? r(null, u) : r(!0, null);
        } catch (e) {
          throw new V(
            { index: e.index + s, message: e.message },
            n,
            i.filename,
          );
        }
      },
      parse: function (r, s, u) {
        var c,
          h,
          f,
          p,
        ...
        if (
          ...
          (h =
            u && u.globalVars
              ? "".concat(e.serializeVars(u.globalVars), "\n")
              : ""),
          (f =
            u && u.modifyVars
              ? "\n".concat(e.serializeVars(u.modifyVars))
              : ""),
          t.pluginManager)
        )
          for (
            ...
            r = m[g].process(r, { context: t, imports: n, fileInfo: i });
        ((h || (u && u.banner)) &&
          ((d = (u && u.banner ? u.banner : "") + h),
          ((p = n.contentsIgnoredChars)[i.filename] = p[i.filename] || 0),
          (p[i.filename] += d.length)),
          (r = d + (r = r.replace(/\r\n?/g, "\n")).replace(/^\uFEFF/, "") + f),
        ...
        try {
          (o.start(r, t.chunkInput, function (e, t) {
            ...
            (c.root = !0),
            (c.firstRoot = !0),
            (c.functionRegistry = ne.inherit()));
        } catch (e) {
          return s(new V(e, n, i.filename));
        }
        var y = o.end();
        if (!y.isFinished) {
        ...
        var w = function (e) {
          return (e = v || e || n.error)
            ? (e instanceof V || (e = new V(e, n, i.filename)), s(e))
            : s(null, c);
        };
        if (!1 === t.processImports) return w();
        new ee.ImportVisitor(n, w).run(c);
      },
      parsers: (a = {
        primary: function () {
        ...
        comment: function () {
          if (o.commentStore.length) {
            ...
            return new He.Comment(e.text, e.isLineComment, e.index + s, i);
          }
        },
        entities: {
          mixinLookup: function () {
            return a.mixin.call(!0, !0);
          },
          quoted: function (e) {
            var t,
              n = o.i,
          ...
          keyword: function () {
            var e =
              o.$char("%") ||
              o.$re(/^\[?(?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+\]?/);
            ...
            if (!o.peek(/^url\(/i))
              if ((o.save(), (e = o.$re(/^([\w-]+|%|~|progid:[\w.]+)\(/)))) {
                ...
                if (((t = this.arguments(t)), o.$char(")")))
                  return (o.forget(), new He.Call(e, t, r + s, i));
          ...
          declarationCall: function () {
            ...
            if ((o.save(), (e = o.$re(/^[\w]+\(/)))) {
              ...
              if (
                ...
                a &&
                  r &&
                  (t = [new He.Declaration(a, r, null, null, o.i + s, i, !0)]),
                o.$char(")"))
              )
                return (o.forget(), new He.Call(e, t, n + s, i));
              o.restore("Could not parse call arguments or missing ')'");
            } else o.forget();
          },
          customFuncCall: function (e) {
            return { alpha: t(a.ieAlpha, !0), boolean: t(n), if: t(n) }[
              e.toLowerCase()
            ];
            function t(e, t) {
            ...
            function n() {
              return [c(a.condition, "expected condition")];
            }
          },
          arguments: function (e) {
            ...
            for (o.save(); ; ) {
              if (e) e = !1;
                ...
                if (
                  !(n =
                    a.detachedRuleset() || this.assignment() || a.expression())
                )
                  break;
              ...
              o.$char(",") ||
                ((o.$char(";") || t) &&
                  ((t = !0),
                  (n = i.length < 1 ? i[0] : new He.Value(i)),
                  r.push(n),
                  (i = [])));
            }
            return (o.forget(), t ? r : i);
          },
          literal: function () {
            return (
              this.dimension() ||
          ...
          variable: function () {
            ...
            if (
              ...
              if (
                ...
                var r = a.variableCall(t);
                if (r) return (o.forget(), r);
              }
              return (o.forget(), new He.Variable(t, n + s, i));
            }
            o.restore();
          },
          variableCurly: function () {
            ...
            if ("@" === o.currentChar() && (e = o.$re(/^@\{([\w-]+)\}/)))
              return new He.Variable("@".concat(e[1]), t + s, i);
          },
          property: function () {
            var e,
              t = o.i;
            if ("$" === o.currentChar() && (e = o.$re(/^\$[\w-]+/)))
              return new He.Property(e, t + s, i);
          },
          propertyCurly: function () {
            var e,
              t = o.i;
            if ("$" === o.currentChar() && (e = o.$re(/^\$\{([\w-]+)\}/)))
              return new He.Property("$".concat(e[1]), t + s, i);
          },
          color: function () {
            var e;
            if (
        ...
        variableCall: function (e) {
          ...
          if (
            ...
            r || (s = s[1]);
            var l = new He.VariableCall(s, n, i);
            return !r && a.end()
              ? (o.forget(), l)
              : (o.forget(), new He.NamespaceValue(l, t, n, i));
          }
          o.restore();
        },
        extend: function (e) {
          ...
          if (o.$str(e ? "&:extend(" : ":extend(")) {
            do {
              ...
              ((r = r && r[1]),
                ...
                (h = new He.Extend(new He.Selector(t), r, f + s, i)),
                a ? a.push(h) : (a = [h]));
            } while (o.$char(","));
            return (c(/^\)/), e && c(/^;/), a);
          }
        ...
        mixin: {
          call: function (e, t) {
            ...
            if ("." === p || "#" === p) {
              if ((o.save(), (r = this.elements()))) {
                ...
                if (e && !n && !c) return void o.restore();
                if ((!e && a.important() && (v = !0), e || a.end())) {
                  o.forget();
                  var g = new He.mixin.Call(r, l, d + s, i, !n && v);
                  return n
                    ? new He.NamespaceValue(g, n)
                    : (c ||
                        u(
          ...
          args: function (e) {
            var t,
              ...
              m = !0;
            for (o.save(); ; ) {
              if (e) u = a.detachedRuleset() || a.expression();
              else {
              ...
              if (
                ...
                if (o.$char(":")) {
                  if (
                    (p.length > 0 &&
                      (t && l("Cannot mix ; and , as delimiter types"),
                      (n = !0)),
                    !(s = a.detachedRuleset() || a.expression()))
                  ) {
                  ...
                  c = !0;
                } else e || ((i = r = g.name), (s = null));
              (s && p.push(s),
                d.push({ name: r, value: s, expand: c }),
                o.$char(",")
                  ? (m = !0)
                  : ((m = ";" === o.$char(";")) || t) &&
                    (n && l("Cannot mix ; and , as delimiter types"),
                    (t = !0),
                    p.length > 1 && (s = new He.Value(p)),
                    v.push({ name: i, value: s, expand: c }),
                    (i = null),
                    (p = []),
                    (n = !1)));
            }
          ...
          definition: function () {
            ...
            if (
              ...
              if (
                ...
                e = t[1];
                var l = this.args(!1);
                if (((r = l.args), (s = l.variadic), !o.$char(")")))
                  return void o.restore("Missing closing ')'");
                if (
                  ((o.commentStore.length = 0),
                  o.$str("when") && (i = c(a.conditions, "expected condition")),
                  (n = a.block()))
                )
                  return (o.forget(), new He.mixin.Definition(e, r, n, i, s));
                o.restore();
              } else o.restore();
          },
        ...
        ieAlpha: function () {
          ...
          if (o.$re(/^opacity=/i))
            return (
              (e = o.$re(/^\d+/)) ||
                ((e = c(a.entities.variable, "Could not parse alpha")),
                (e = "@{".concat(e.name.slice(1), "}"))),
              h(")"),
              new He.Quoted("", "alpha(opacity=".concat(e, ")"))
            );
        },
        element: function () {
          var e,
          ...
          if (
            ...
            if ((o.save(), o.$char("(")))
              if ((n = this.selector(!1))) {
                for (var a = []; o.$char(","); )
                  (a.push(n), a.push(new se(",")), (n = this.selector(!1)));
                (a.push(n),
                  o.$char(")")
                    ? ((e =
                        a.length > 1
                          ? new He.Paren(new oe(a))
                          : new He.Paren(n)),
                      o.forget())
                    : o.restore("Missing closing ')'"));
              } else o.restore("Missing closing ')'");
            else o.forget();
          if (e)
            return new He.Element(t, e, e instanceof He.Variable, r + s, i);
        },
        combinator: function () {
          var e = o.currentChar();
          if ("/" === e) {
        ...
        selector: function (e) {
          ...
          for (
            ...
            ((e && (n = this.extend())) ||
              ...
              (a = this.element())) &&
            (h
              ? (f = c(this.conditions, "expected condition"))
              : f
                ? l("CSS guard can only be used at the end of selector")
                : n
                  ? (u = u ? u.concat(n) : n)
                  : (u && l("Extend can only be used at the end of selector"),
                    (r = o.currentChar()),
                    Array.isArray(a) &&
          ...
          if (t) return new He.Selector(t, u, f, p + s, i);
          u &&
            l(
        ...
        selectors: function () {
          for (
            ...
            e.condition &&
              t.length > 1 &&
              l("Guards are only currently allowed on a single selector."),
            o.$char(","));
          )
            (e.condition &&
              l("Guards are only currently allowed on a single selector."),
          ...
          if (
            ...
            if (i)
              return (
                o.forget(),
                t
                  ? new He.mixin.Definition(null, t, i, null, n)
                  : new He.DetachedRuleset(i)
              );
            o.restore();
          } else o.restore();
        },
        ruleset: function () {
          ...
          if (
            (o.save(),
            t.dumpLineNumbers && (i = f(o.i)),
            (e = this.selectors()) && (n = this.block()))
          ) {
            o.forget();
            var r = new He.Ruleset(e, n, t.strictImports);
        ...
        declaration: function () {
          ...
          if ("." !== c && "#" !== c && "&" !== c && ":" !== c)
            if ((o.save(), (e = this.variable() || this.ruleProperty()))) {
                ...
                if (
                  ...
                  (t =
                    e[0].value && "--" === e[0].value.slice(0, 2)
                      ? o.$char(";")
                        ? new se("")
                        : this.permissiveValue(/[;}]/, !0)
                      : this.anonymousValue()))
                )
                  return (
                    o.forget(),
                    new He.Declaration(e, t, !1, a, u + s, i)
                  );
                (t || (t = this.value()),
                  t
                    ? (r = this.important())
              ...
              if (t && (this.end() || n))
                return (o.forget(), new He.Declaration(e, t, r, a, u + s, i));
              o.restore();
            } else o.restore();
        },
        anonymousValue: function () {
          var e = o.i,
            t = o.$re(/^([^.#@$+/'"*`(;{}-]*);/);
          if (t) return new He.Anonymous(t[1], e + s);
        },
        permissiveValue: function (e) {
          ...
          function f() {
            var e = o.currentChar();
            return "string" == typeof a ? e === a : a.test(e);
          }
          if (!f()) {
            s = [];
            do {
              (n = this.comment())
                ? s.push(n)
                : ((n = this.entity()) && s.push(n),
                  o.peek(",") &&
                    (s.push(new He.Anonymous(",", o.i)), o.$char(",")));
            } while (n);
            if (((r = f()), s.length > 0)) {
              if (((s = new He.Expression(s)), r)) return s;
              (h.push(s),
                " " === o.prevChar() && h.push(new He.Anonymous(" ", c)));
            }
            if ((o.save(), (s = o.$parseUntil(a)))) {
              if (
                ("string" == typeof s &&
                  l("Expected '".concat(s, "'"), "Parse"),
                1 === s.length && " " === s[0])
              )
                return (o.forget(), new He.Anonymous("", c));
              var p = void 0;
              for (t = 0; t < s.length; t++)
                if (((p = s[t]), Array.isArray(p)))
                  h.push(new He.Quoted(p[0], p[1], !0, c, i));
                else {
                  t === s.length - 1 && (p = p.trim());
                  var v = new He.Quoted("'", p, !0, c, i);
                  (/@([\w-]+)/g.test(p) &&
                    u(
                    ...
                    (v.variableRegex = /@([\w-]+)|@{([\w-]+)}/g),
                    (v.propRegex = /\$([\w-]+)|\${([\w-]+)}/g),
                    h.push(v));
                }
              return (o.forget(), new He.Expression(h, !0));
            }
            o.restore();
          }
        },
          ...
          if (r) {
            ...
            if ((e = this.entities.quoted() || this.entities.url()))
              return (
                ...
                (t = t && new He.Value(t)),
                new He.Import(e, t, a, n + s, i)
              );
            ((o.i = n), l("malformed import statement"));
          }
        },
              ...
              : o.$char("(") &&
                ...
                o.$re(/^[0-9a-z-]*\s*([<>]=|<=|>=|[<>]|=)/)
                  ? (o.restore(),
                    (n = this.condition()),
                    o.save(),
                    (r = this.atomicCondition(null, n.rvalue)) || o.restore())
                  ...
                  ? n && !t
                    ...
                    : n && t
                      ...
                      : t
                        ...
                        : l("badly formed media feature definition")
                  : l("Missing closing ')'", "Parse"));
          } while (t);
        ...
        mediaFeatures: function (e) {
          ...
          do {
            if ((t = this.mediaFeature(e))) {
              if ((i.push(t), !o.$char(","))) break;
            } else if (
              (t = n.variable() || n.mixinLookup()) &&
              (i.push(t), !o.$char(","))
            )
              break;
          } while (t);
        ...
        prepareAndGetNestableAtRule: function (e, n, r, a) {
          var u = this.mediaFeatures(a),
            c = this.block();
          (c ||
            l("media definitions require block statements after any features"),
            o.forget());
          var h = new e(c, u, n + s, i);
          return (t.dumpLineNumbers && (h.debugInfo = r), h);
        },
        nestableAtRule: function () {
          var e,
            n = o.i;
          if ((t.dumpLineNumbers && (e = f(n)), o.save(), o.$peekChar("@"))) {
            if (o.$str("@media"))
              return this.prepareAndGetNestableAtRule(He.Media, n, e, ie);
            if (o.$str("@container"))
              return this.prepareAndGetNestableAtRule(He.Container, n, e, re);
          }
          o.restore();
        },
        plugin: function () {
          ...
          if (o.$re(/^@plugin\s+/)) {
            if (
              ...
              return (
                o.$char(";") || ((o.i = r), l("missing semi-colon on @plugin")),
                new He.Import(e, null, n, r + s, i)
              );
            ((o.i = r), l("malformed @plugin statement"));
          }
        },
        pluginArgs: function () {
        ...
        atrule: function () {
          var e,
            ...
            m = !1;
          if ("@" === o.currentChar()) {
            if ((n = this.import() || this.plugin() || this.nestableAtRule()))
              return n;
            if ((o.save(), (e = o.$re(/^@[a-z-]+/)))) {
              switch (
                ...
                "-" == e.charAt(1) &&
                  e.indexOf("-", 2) > 0 &&
                  (a = "@".concat(e.slice(e.indexOf("-", 2) + 1))),
                a)
              ) {
                case "@charset":
                  ((u = !0), (v = !1));
              ...
              if (
                ...
                u
                  ? (n = this.entity()) ||
                    l("expected ".concat(e, " identifier"))
                  : c
                    ? (n = this.expression()) ||
                      l("expected ".concat(e, " expression"))
                    : h &&
                ...
                if (
                  ((r = this.blockRuleset()),
                  o.save(),
                  r || d || ((n = this.entity()), (r = this.blockRuleset())),
                  r || d)
                )
                  o.forget();
                else {
                  o.restore();
                  var g = [];
                  for (n = this.entity(); o.$char(","); )
                    (g.push(n), (n = this.entity()));
                  n && g.length > 0
                    ? (g.push(n), (n = g), (m = !0))
                    : (r = this.blockRuleset());
                }
        ...
        value: function () {
          ...
          if (t.length > 0) return new He.Value(t, n + s);
        },
        important: function () {
        ...
        colorOperand: function () {
          o.save();
          var e = o.$re(/^[lchrgbs]\s+/);
          if (e) return new He.Keyword(e[0]);
          o.restore();
        },
        multiplication: function () {
          ...
          if ((e = this.operand())) {
            for (r = o.isWhitespace(-1); !o.peek(/^\/[*/]/); ) {
              if ((o.save(), !(n = o.$char("/") || o.$char("*")))) {
                var s = o.i;
                (n = o.$str("./")) &&
                  u("./ operator is deprecated", s, "DEPRECATED");
              }
              if (!n) {
                o.forget();
                break;
        ...
        conditions: function () {
          ...
          if ((e = this.condition(!0))) {
            for (
              ...
              n = new He.Condition("or", n || e, t, i + s);
            return n || e;
          }
        },
        ...
        parenthesisCondition: function (e) {
          ...
          if ((o.save(), o.$str("("))) {
            ...
            if ((t = this.atomicCondition(e))) {
              ...
              o.restore("expected ')' got '".concat(o.currentChar(), "'"));
            } else o.restore();
          } else o.restore();
        },
        atomicCondition: function (e, t) {
          var n,
            ...
            h = function () {
              return (
                this.addition() || u.keyword() || u.quoted() || u.mixinLookup()
              );
            }.bind(this);
          if ((n = t || h()))
            return (
              ...
              a
                ? (i = h())
                  ? (r = new He.Condition(a, n, i, c + s, !1))
        ...
        operand: function () {
          ...
          var n =
            ...
            this.colorOperand() ||
            t.mixinLookup();
          return (e && ((n.parensInOp = !0), (n = new He.Negative(n))), n);
        },
        expression: function () {
          var e,
            t,
            ...
            i = o.i;
          do {
            !(e = this.comment()) || e.isLineComment
              ? ((e = this.addition() || this.entity()) instanceof He.Comment &&
                  (e = null),
                e &&
                  (n.push(e),
                  o.peek(/^\/[/*]/) ||
                    ((t = o.$char("/")) && n.push(new He.Anonymous(t, i + s)))))
              : n.push(e);
          } while (e);
          if (n.length > 0) return new He.Expression(n);
        },
        property: function () {
        ...
        ruleProperty: function () {
          ...
          if (a) return ((n = [new He.Keyword(a[1])]), o.forget(), n);
          function l(e) {
            var t = o.i,
              i = o.$re(e);
              ...
              ((e = n[t]),
                (n[t] =
                  "@" !== e.charAt(0) && "$" !== e.charAt(0)
                    ? new He.Keyword(e)
                    : "@" === e.charAt(0)
                      ? new He.Variable("@".concat(e.slice(2, -1)), r[t] + s, i)
                      : new He.Property(
                          "$".concat(e.slice(2, -1)),
                          r[t] + s,
                          i,
  ...
  var oe = function (e, t, n, i, r, s) {
    ((this.extendList = t),
      (this.condition = n),
      (this.evaldCondition = !n),
      (this._index = i),
      (this._fileInfo = r),
  ...
  oe.prototype = Object.assign(new u(), {
    ...
    createDerived: function (e, t, n) {
      ...
      return (
        (i.evaldCondition = M(n) ? this.evaldCondition : n),
        (i.mediaEmpty = this.mediaEmpty),
        i
      );
    },
      ...
      return e
        ? ("string" == typeof e &&
            new ae(
              ...
              this._fileInfo,
              this._index,
            ).parseNode(e, ["selector"], function (t, n) {
              if (t)
                throw new V(
    ...
    createEmptySelectors: function () {
      var e = new g("", "&", !1, this._index, this._fileInfo),
        t = [new oe([e], null, null, this._index, this._fileInfo)];
  ...
  ((ue.prototype = Object.assign(new u(), {
    ...
    (ue.True = new ue("true")),
    (ue.False = new ue("false")));
  var ce = y;
  var he = function (e, t, n, i, r, s, a, o) {
    ((this.name = e),
      (this.value = t instanceof u ? t : new le([t ? new se(t) : null])),
      (this.important = n ? " ".concat(n.trim()) : ""),
      (this.merge = i),
      (this._index = r),
      (this._fileInfo = s),
      (this.inline = a || !1),
      (this.variable = void 0 !== o ? o : e.charAt && "@" === e.charAt(0)),
      (this.allowRoot = !0),
      this.setParent(this.value, this));
  };
  function fe(e) {
    return "/* line "
      .concat(e.debugInfo.lineNumber, ", ")
      .concat(e.debugInfo.fileName, " */\n");
  }
  function pe(e) {
    var t = e.debugInfo.fileName;
    return (
      /^[a-z]+:\/\//i.test(t) || (t = "file://".concat(t)),
        ...
        ((r =
          1 === r.length && r[0] instanceof ue
            ...
            : (function (e, t) {
                ...
                for (n = 0; n < r; n++) t[n].eval(e).genCSS(e, s);
                return i;
              })(e, r)),
        (s = !1)),
        "font" === r &&
          e.math === ce.ALWAYS &&
          ((i = !0), (t = e.math), (e.math = ce.PARENS_DIVISION)));
      try {
        if (
          (e.importantScope.push({}),
          (n = this.value.eval(e)),
          !this.variable && "DetachedRuleset" === n.type)
        )
          throw {
        ...
        var a = this.important,
          o = e.importantScope.pop();
        return (
          !a && o.important && (a = o.important),
          new he(
            r,
            n,
            a,
  ...
  de.prototype = Object.assign(new u(), {
    type: "Comment",
    genCSS: function (e, t) {
      (this.debugInfo && t.add(ve(e, this), this.fileInfo(), this.getIndex()),
        t.add(this.value));
    },
    isSilent: function (e) {
  ...
  var me = {
      eval: function () {
        var e = this.value_,
          t = this.error_;
        if (t) throw t;
        if (!M(e)) return e ? ue.True : ue.False;
      },
      value: function (e) {
        this.value_ = e;
      },
  ...
  ge.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      var t,
        ...
        s,
        a = !1;
      if (this.selectors && (n = this.selectors.length)) {
        for (
          t = new Array(n),
            me.error({
              type: "Syntax",
          ...
          i = this.selectors[r].eval(e);
          for (var o = 0; o < i.elements.length; o++)
            if (i.elements[o].isVariable) {
              s = !0;
              break;
            }
          ((t[r] = i), i.evaldCondition && (a = !0));
        }
        if (s) {
          var l = new Array(n);
          for (r = 0; r < n; r++) ((i = t[r]), (l[r] = i.toCSS(e)));
          var c = t[0].getIndex(),
            h = t[0].fileInfo();
          new ae(e, this.parse.importManager, h, c).parseNode(
            l.join(","),
            ["selectors"],
            function (e, n) {
              n && (t = R(n));
      ...
      var f,
        p,
        v = this.rules ? A(this.rules) : null,
        d = new ge(t, v, this.strictImports, this.visibilityInfo());
      ...
      for (r = 0; (f = y[r]); r++)
        "MixinCall" === f.type
          ? ((v = f.eval(e).filter(function (e) {
              return !(e instanceof he && e.variable) || !d.variable(e.name);
            })),
          ...
          : "VariableCall" === f.type &&
            ((v = f.eval(e).rules.filter(function (e) {
              return !(e instanceof he && e.variable);
            })),
            y.splice.apply(y, [r, 1].concat(v)),
            (r += v.length - 1),
            d.resetCache());
      ...
      for (r = 0; (f = y[r]); r++)
        if (
          ...
          y.splice(r--, 1);
          for (o = 0; (p = f.rules[o]); o++)
            p instanceof u &&
              (p.copyVisibilityInfo(f.visibilityInfo()),
              (p instanceof he && p.variable) || y.splice(++r, 0, p));
        }
    ...
    matchCondition: function (e, t) {
      ...
      return (
        !!n.evaldCondition &&
        !(n.condition && !n.condition.eval(new B.Eval(t, t.frames)))
      );
    },
    resetCache: function () {
      ((this._rulesets = null),
        ...
        this._variables ||
          (this._variables = this.rules
            ? this.rules.reduce(function (e, t) {
                if (
                  (t instanceof he && !0 === t.variable && (e[t.name] = t),
      ...
      return (
        this._properties ||
          (this._properties = this.rules
            ? this.rules.reduce(function (e, t) {
                if (t instanceof he && !0 !== t.variable) {
                  var n =
                    1 === t.name.length && t.name[0] instanceof ue
                      ? t.name[0].value
                      : t.name;
                  e["$".concat(n)]
                    ? e["$".concat(n)].push(t)
    ...
    lastDeclaration: function () {
      for (var e = this.rules.length; e > 0; e--) {
        ...
        if (t instanceof he) return this.parseValue(t);
      }
    },
    parseValue: function (e) {
      var t = this;
      function n(e) {
        return e.value instanceof se && !e.parsed
    ...
    find: function (e, t, n) {
      ...
      var i,
        ...
        s = [],
        a = e.toCSS();
      return a in this._lookups
        ? this._lookups[a]
        : (this.rulesets().forEach(function (a) {
            if (a !== t)
              for (var o = 0; o < a.selectors.length; o++)
                if ((i = e.match(a.selectors[o]))) {
                  if (e.elements.length > i) {
                    if (!n || n(a)) {
                      r = a.find(new oe(e.elements.slice(i)), t, n);
                      for (var l = 0; l < r.length; ++l) r[l].path.push(a);
    ...
    joinSelector: function (e, t, n) {
      ...
      function s(e, t, n, i) {
        ...
        if (
          ((r = []),
          e.length > 0
            ? ((s = (r = A(e)).pop()), (a = i.createDerived(A(s.elements))))
            : (a = i.createDerived([])),
          t.length > 0)
        ) {
          var o = n.combinator,
          ...
          (o.emptyOrWhitespace &&
            ...
            (o = l.combinator),
            a.elements.push(
              new g(o, l.value, n.isVariable, n._index, n._fileInfo),
            ),
            (a.elements = a.elements.concat(t[0].elements.slice(1))));
        }
        if ((0 !== a.elements.length && r.push(a), t.length > 1)) {
          var u = t.slice(1);
          ((u = u.map(function (e) {
        ...
        !(function e(t, n, l) {
          ...
          for (f = [], p = [[]], u = 0; (y = l.elements[u]); u++)
            if ("&" !== y.value) {
              var C =
                ((S = void 0),
                (x = y).value instanceof v && (S = x.value.value) instanceof oe
                  ? S
                  : null);
              if (null !== C) {
                o(f, p);
                var k,
                  A = [],
                  _ = [];
                for (k = e(A, n, C), I = I || k, h = 0; h < A.length; h++) {
                  a(p, [r(i(A[h], y), y)], y, l, _);
                }
                ((p = _), (f = []));
              } else f.push(y);
            } else {
              for (I = !0, d = [], o(f, p), c = 0; c < p.length; c++)
                if (((m = p[c]), 0 === n.length))
                  (m.length > 0 &&
                    m[0].elements.push(
                      new g(
  ...
  var ye = function (e, t, n) {
    ((this.numerator = e ? A(e).sort() : []),
      (this.denominator = t ? A(t).sort() : []),
      n ? (this.backupUnit = n) : e && e.length && (this.backupUnit = e[0]));
  };
  ye.prototype = Object.assign(new u(), {
    type: "Unit",
    clone: function () {
      return new ye(A(this.numerator), A(this.denominator), this.backupUnit);
    },
    genCSS: function (e, t) {
    ...
    usedUnits: function () {
      ...
      o))
        o.hasOwnProperty(n) && ((e = o[n]), this.map(t));
      return i;
    },
    cancel: function () {
      var e,
  ...
  be.prototype = Object.assign(new u(), {
    ...
    operate: function (e, t, n) {
      var i = this._operate(e, t, this.value, n.value),
        r = this.unit.clone();
      if ("+" === t || "-" === t)
        if (0 === r.numerator.length && 0 === r.denominator.length)
          ((r = n.unit.clone()),
            this.unit.backupUnit && (r.backupUnit = this.unit.backupUnit));
        else if (0 === n.unit.numerator.length && 0 === r.denominator.length);
        else {
          if (
            ((n = n.convertTo(this.unit.usedUnits())),
            e.strictUnits && n.unit.toString() !== r.toString())
          )
            throw new Error(
              "Incompatible units. Change the units or use the unit function. " +
                "Bad units: '"
                  .concat(r.toString(), "' and '")
                  .concat(n.unit.toString(), "'."),
            );
          i = this._operate(e, t, this.value, n.value);
        }
      else
        "*" === t
          ? ((r.numerator = r.numerator.concat(n.unit.numerator).sort()),
            (r.denominator = r.denominator.concat(n.unit.denominator).sort()),
            r.cancel())
          : "/" === t &&
            ((r.numerator = r.numerator.concat(n.unit.denominator).sort()),
            (r.denominator = r.denominator.concat(n.unit.numerator).sort()),
            r.cancel());
      return new be(i, r);
    },
    compare: function (e) {
      ...
      if (e instanceof be) {
        if (this.unit.isEmpty() || e.unit.isEmpty()) ((t = this), (n = e));
          ...
          ((t = this.unify()), (n = e.unify()), 0 !== t.unit.compare(n.unit))
        )
          return;
        return u.numericCompare(t.value, n.value);
      }
    },
    unify: function () {
    ...
    convertTo: function (e) {
      var t,
        ...
        u = {};
      if ("string" == typeof e) {
        for (t in o) o[t].hasOwnProperty(e) && ((u = {})[t] = e);
        e = u;
      }
      for (n in ((s = function (e, t) {
        return i.hasOwnProperty(e)
          ? (t ? (a /= i[e] / i[r]) : (a *= i[e] / i[r]), r)
          : e;
      }),
      e))
        e.hasOwnProperty(n) && ((r = e[n]), (i = o[n]), l.map(s));
      return (l.cancel(), new be(a, l));
    },
  });
  var we = function (e, t) {
  ...
  we.prototype = Object.assign(new u(), {
    ...
    genCSS: function (e, t) {
      for (var n = 0; n < this.value.length; n++)
        (this.value[n].genCSS(e, t),
          !this.noSpacing &&
            n + 1 < this.value.length &&
            ((n + 1 < this.value.length &&
              !(this.value[n + 1] instanceof se)) ||
              (this.value[n + 1] instanceof se &&
                "," !== this.value[n + 1].value)) &&
            t.add(" "));
    },
  ...
  var xe = {
      ...
      evalTop: function (e) {
        ...
        if (e.mediaBlocks.length > 1) {
          ...
          (((t = new ge(n, e.mediaBlocks)).multiMedia = !0),
      ...
      evalNested: function (e) {
        ...
        for (t = 0; t < i.length; t++) {
          if (i[t].type !== this.type)
            return (e.mediaBlocks.splice(t, 1), this);
          ((n =
            i[t].features instanceof le ? i[t].features.value : i[t].features),
            (i[t] = Array.isArray(n) ? n : [n]));
        }
        return (
          (this.features = new le(
            this.permute(i).map(function (e) {
              for (
                e = e.map(function (e) {
                  return e.toCSS ? e : new se(e);
                }),
                  t = e.length - 1;
                t > 0;
                t--
              )
                e.splice(t, 0, new se("and"));
              return new we(e);
            }),
          )),
      ...
      bubbleSelectors: function (e) {
        e &&
          ((this.rules = [new ge(A(e), [this.rules[0]])]),
          this.setParent(this.rules, this));
      },
    },
    Se = function (e, t, n, i, r, s, a, o) {
      var l,
        c = this,
        h = new oe(
          [],
      ...
      if (
        ((this.name = e),
        (this.value = t instanceof u ? t : t ? new se(t) : t),
        n)
      ) {
        if (Array.isArray(n)) {
          var f = this.declarationsBlock(n),
            p = !0;
          (n.forEach(function (e) {
            "Ruleset" === e.type &&
              e.rules &&
              (p = p && c.declarationsBlock(e.rules, !0));
          }),
            f && !a
              ? ((this.simpleBlock = !0), (this.declarations = n))
              : !p || 1 !== n.length || a || t
                ? (this.rules = n)
                : ((this.simpleBlock = !0),
                  (this.declarations = n[0].rules ? n[0].rules : n)));
        } else {
          !(f = this.declarationsBlock(n.rules)) || a || t
            ? ((this.rules = [n]),
              (this.rules[0].selectors = new oe(
                [],
                null,
                null,
                i,
            ...
            : ((this.simpleBlock = !0), (this.declarations = n.rules));
        }
        if (!this.simpleBlock)
          for (l = 0; l < this.rules.length; l++)
            this.rules[l].allowImports = !0;
        (this.setParent(h, this), this.setParent(this.rules, this));
      }
      ((this._index = i),
        (this._fileInfo = r),
        (this.debugInfo = s),
  ...
  Se.prototype = Object.assign(
    new u(),
    p(p({ type: "AtRule" }, xe), {
      declarationsBlock: function (e, t) {
        return (
          void 0 === t && (t = !1),
          t
            ? e.filter(function (e) {
            ...
            : e.filter(function (e) {
                return (
                  ("Declaration" === e.type || "Comment" === e.type) && !e.merge
                );
              }).length === e.length
        );
      },
      keywordList: function (e) {
        return (
          !!Array.isArray(e) &&
          e.filter(function (e) {
      ...
      accept: function (e) {
        var t = this.value,
          ...
          i = this.declarations;
        (n
          ? (this.rules = e.visitArray(n))
          : i && (this.declarations = e.visitArray(i)),
      ...
      genCSS: function (e, t) {
        var n = this.value,
          i = this.rules || this.declarations;
        (t.add(this.name, this.fileInfo(), this.getIndex()),
          n && (t.add(" "), n.genCSS(e, t)),
          this.simpleBlock
            ? this.outputRuleset(e, t, this.declarations)
            : i
              ? this.outputRuleset(e, t, i)
              : t.add(";"));
      },
      eval: function (e) {
        var t,
          n,
          i = this.value,
          r = this.rules || this.declarations;
        ((t = e.mediaPath),
        (n = e.mediaBlocks),
        (e.mediaPath = []),
        (e.mediaBlocks = []),
        ...
        r && (r = this.evalRoot(e, r)),
        Array.isArray(r) &&
          r[0].rules &&
          Array.isArray(r[0].rules) &&
          r[0].rules.length) &&
          (!this.declarationsBlock(r[0].rules, !0) ||
            this.isRooted ||
            i ||
            ((0,
            e.pluginManager.less.visitors.ToCSSVisitor.prototype._mergeRules)(
              r[0].rules,
            ),
            (r = r[0].rules).forEach(function (e) {
              return (e.merge = !1);
            })));
        return (
          this.simpleBlock &&
            r &&
            ((r[0].functionRegistry = e.frames[0].functionRegistry.inherit()),
            (r = r.map(function (t) {
              return t.eval(e);
            }))),
          (e.mediaPath = t),
      ...
      evalRoot: function (e, t) {
        ...
        var u = n > 0 && i > 0 && !s && !r;
        return (
          ((this.isRooted && n > 0 && 0 === i && !s && r) || !u) &&
            (t[0].root = !0),
          t
        );
      },
      variable: function (e) {
        if (this.rules) return ge.prototype.variable.call(this.rules[0], e);
      },
      find: function () {
        if (this.rules)
      ...
      rulesets: function () {
        if (this.rules) return ge.prototype.rulesets.apply(this.rules[0]);
      },
      outputRuleset: function (e, t, n) {
        var i,
          r = n.length;
        ...
        var s = "\n".concat(Array(e.tabLevel).join("  ")),
          a = "".concat(s, "  ");
        if (r) {
          for (t.add(" {".concat(a)), n[0].genCSS(e, t), i = 1; i < r; i++)
            (t.add(a), n[i].genCSS(e, t));
          t.add("".concat(s, "}"));
        } else t.add(" {".concat(s, "}"));
        e.tabLevel--;
      },
  ...
  Ie.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      var t = this.frames || A(e.frames);
      return new Ie(this.ruleset, t);
    },
    callEval: function (e) {
      return this.ruleset.eval(
        this.frames ? new B.Eval(e, this.frames.concat(e.frames)) : e,
      );
    },
  });
  var Ce = y,
  ...
  ke.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      var t,
        n = this.operands[0].eval(e),
        i = this.operands[1].eval(e);
      if (e.isMathOn(this.op)) {
        if (
          ((t = "./" === this.op ? "/" : this.op),
          n instanceof be && i instanceof c && (n = n.toColor()),
          i instanceof be && n instanceof c && (i = i.toColor()),
          !n.operate || !i.operate)
        ) {
          if (
            (n instanceof ke || i instanceof ke) &&
            "/" === n.op &&
            e.math === Ce.PARENS_DIVISION
          )
            return new ke(this.op, [n, i], this.isSpaced);
          throw { type: "Operation", message: "Operation on an invalid type" };
        }
        return n.operate(e, t, i);
      }
      return new ke(this.op, [n, i], this.isSpaced);
    },
    genCSS: function (e, t) {
  ...
  _e.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      var i,
        r = function () {
          ((t.calc || e.inCalc) && e.exitCalc(), (e.mathOn = n));
        },
        s = new Ae(this.name, e, this.getIndex(), this.fileInfo());
      if (s.isValid())
        try {
          ((i = s.call(this.args)), r());
        } catch (e) {
      ...
      if (null != i)
        return (
          i instanceof u || (i = new se(i && !0 !== i ? i.toString() : null)),
      ...
      return (r(), new _e(this.name, a, this.getIndex(), this.fileInfo()));
    },
    genCSS: function (e, t) {
  ...
  var Pe = function (e, t, n) {
    ((this.name = e), (this._index = t), (this._fileInfo = n));
  };
  Pe.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      if (
        (0 === n.indexOf("@@") &&
          (n = "@".concat(
            new Pe(n.slice(1), this.getIndex(), this.fileInfo()).eval(e).value,
          )),
        this.evaluating)
      )
        throw {
          type: "Name",
          message: "Recursive variable definition for ".concat(n),
          filename: this.fileInfo().filename,
          index: this.getIndex(),
        };
      if (
      ...
      throw {
        type: "Name",
        message: "variable ".concat(n, " is undefined"),
        filename: this.fileInfo().filename,
        index: this.getIndex(),
      };
    },
      ...
      if (
        ...
        (t = this.find(e.frames, function (t) {
          ...
          if (s) {
            ...
            if ((i(s), (r = s[s.length - 1]).important))
              e.importantScope[e.importantScope.length - 1].important =
                r.important;
  ...
  var Re = function (e, t, n, i) {
    ((this.key = e), (this.op = t), (this.value = n), (this.cif = i));
  };
  ...
  var Me = function (e, t, n, i, r) {
    ((this.escaped = void 0 === n || n),
      (this.value = t || ""),
  ...
  Me.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      return (
        (n = i(n, this.variableRegex, function (n, i, r) {
          var s = new Pe(
            "@".concat(null != i ? i : r),
            t.getIndex(),
            t.fileInfo(),
          ).eval(e, !0);
          return s instanceof Me ? s.value : s.toCSS();
        })),
        (n = i(n, this.propRegex, function (n, i, r) {
          var s = new Ee(
            "$".concat(null != i ? i : r),
            t.getIndex(),
            t.fileInfo(),
  ...
  Oe.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      if (
        ...
        e.pathRequiresRewrite(n.value)
          ? (n.quote ||
              (t = t.replace(/[()'"\s]/g, function (e) {
                return "\\".concat(e);
              })),
            (n.value = e.rewritePath(n.value, t)))
          : (n.value = e.normalizePath(n.value)),
        e.urlArgs && !n.value.match(/^\s*data:/))
      ) {
        var i = (-1 === n.value.indexOf("?") ? "?" : "&") + e.urlArgs;
        -1 !== n.value.indexOf("#")
          ? (n.value = n.value.replace("#", "".concat(i, "#")))
          : (n.value += i);
      }
      return new Oe(n, this.getIndex(), this.fileInfo(), !0);
    },
  });
  var $e = function (e, t, n, i, r) {
    ((this._index = n), (this._fileInfo = i));
    var s = new oe(
      [],
      null,
      null,
    ...
    ((this.features = new le(t)),
      (this.rules = [new ge(s, e)]),
  ...
  Ve.prototype = Object.assign(new u(), {
    ...
    getPath: function () {
      return this.path instanceof Oe ? this.path.value.value : this.path.value;
    },
    isVariableImport: function () {
      var e = this.path;
      return (
        e instanceof Oe && (e = e.value),
        !(e instanceof Me) || e.containsVariables()
      );
    },
    ...
    doEval: function (e) {
      var t,
        n,
        i = this.features && this.features.eval(e);
      if (this.options.isPlugin) {
        ...
        return (
          (n = e.frames[0] && e.frames[0].functionRegistry) &&
            this.root &&
            this.root.functions &&
            n.addMultiple(this.root.functions),
          []
        );
      }
      if (
        ...
        return [];
      if (this.features) {
        var r = this.features.value;
        if (Array.isArray(r) && r.length >= 1)
          if (
            "Expression" === (o = r[0]).type &&
            Array.isArray(o.value) &&
            o.value.length >= 2
          )
            "Keyword" === (r = o.value)[0].type &&
              "layer" === r[0].value &&
              "Paren" === r[1].type &&
              (this.css = !1);
      }
      if (this.options.inline) {
        ...
        return this.features ? new $e([s], this.features.value) : [s];
      }
      if (this.css || this.layerCss) {
        var a = new Ve(this.evalPath(e), i, this.options, this._index);
        if (
          (this.layerCss &&
            ((a.css = this.layerCss), (a.path._fileInfo = this._fileInfo)),
          !a.css && this.error)
        )
          throw this.error;
        return a;
      ...
      if (this.root) {
        ...
        return (
          (t = new ge(null, A(this.root.rules))).evalImports(e),
          this.features ? new $e(t.rules, this.features.value) : t.rules
        );
      }
      if (this.features) {
        r = this.features.value;
        if (Array.isArray(r) && r.length >= 1)
          if (((r = r[0].value), Array.isArray(r) && r.length >= 2))
            if (
              "Keyword" === r[0].type &&
              "layer" === r[0].value &&
              "Paren" === r[1].type
  ...
  Fe.prototype = Object.assign(new u(), {
    evaluateJavaScript: function (e, t) {
      ...
      e = e.replace(/@\{([\w-]+)\}/g, function (e, n) {
        return i.jsify(
          new Pe("@".concat(n), i.getIndex(), i.fileInfo()).eval(t),
        );
      });
      try {
  ...
  Le.prototype = Object.assign(new Fe(), {
    type: "JavaScript",
    eval: function (e) {
      ...
      return "number" !== n || isNaN(t)
        ? "string" === n
          ? new Me('"'.concat(t, '"'), t, this.escaped, this._index)
          : Array.isArray(t)
            ? new se(t.join(", "))
            : new se(t)
        : new be(t);
  ...
  var Ne = function (e, t, n, i, r, s) {
    ((this.op = e.trim()),
      (this.lvalue = t),
      (this.mvalue = n),
      (this.op2 = i ? i.trim() : null),
      (this.rvalue = r),
      (this._index = s),
      (this.mvalues = []));
  };
  Ne.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      for (
        ...
        (n = e.frames[i]) &&
        ("Ruleset" !== n.type ||
          !(t = n.rules.find(function (e) {
            return !!(e instanceof he && e.variable);
          })));
        i++
      );
      return (
        this.mvalueCopy || (this.mvalueCopy = C(this.mvalue)),
        t
    ...
    genCSS: function (e, t) {
      (this.lvalue.genCSS(e, t),
        t.add(" " + this.op + " "),
        this.mvalues.length > 0 && (this.mvalue = this.mvalues.shift()),
  ...
  qe.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      return e.isMathOn()
        ? new ke("*", [new be(-1), this.value]).eval(e)
  ...
  ze.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      var t,
        n = new Pe(this.variable, this.getIndex(), this.fileInfo()).eval(e),
        i = new V({
          message: "Could not evaluate variable call ".concat(this.variable),
        });
      if (!n.ruleset) {
        if (n.rules) t = n;
        else if (Array.isArray(n)) t = new ge("", n);
        else {
  ...
  Ge.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      for (t = 0; t < this.lookups.length; t++) {
        if (
          ((n = this.lookups[t]),
          Array.isArray(i) && (i = new ge([new oe()], i)),
          "" === n)
        )
          i = i.lastDeclaration();
        else if ("@" === n.charAt(0)) {
          if (
            ("@" === n.charAt(1) &&
              (n = "@".concat(new Pe(n.substr(1)).eval(e).value)),
          ...
          if (
            ((n =
              "$@" === n.substring(0, 2)
                ? "$".concat(new Pe(n.substr(1)).eval(e).value)
                : "$" === n.charAt(0)
                  ? n
                  : "$".concat(n)),
  ...
  var We = function (e, t, n, i, r, s, a) {
    ((this.name = e || "anonymous mixin"),
      (this.selectors = [
        new oe([new g(null, e, !1, this._index, this._fileInfo)]),
      ]),
      (this.params = t),
      (this.condition = i),
      (this.variadic = r),
    ...
    ((this.required = t.reduce(function (e, t) {
      return !t.name || (t.name && !t.value) ? e + 1 : (o.push(t.name), e);
    }, 0)),
  ...
  We.prototype = Object.assign(new ge(), {
    ...
    evalParams: function (e, t, n, i) {
      ...
      if (
        ...
        (t = new B.Eval(t, [f].concat(t.frames))),
        n)
      )
        for (v = (n = A(n)).length, a = 0; a < v; a++)
          if ((u = (s = n[a]) && s.name)) {
            for (c = !1, o = 0; o < p.length; o++)
              if (!i[o] && u === p[o].name) {
                ((i[o] = s.value.eval(e)),
                  f.prependRule(new he(u, s.value.eval(e))),
                  (c = !0));
                break;
              }
            if (c) {
            ...
            throw {
              ...
              message: "Named argument for "
                .concat(this.name, " ")
                .concat(n[a].name, " not found"),
            };
          }
      for (h = 0, a = 0; a < p.length; a++)
        if (!i[a]) {
          if (((s = n && n[h]), (u = p[a].name)))
            if (p[a].variadic) {
              for (r = [], o = h; o < v; o++) r.push(n[o].value.eval(e));
              f.prependRule(new he(u, new we(r).eval(e)));
            } else {
              if ((l = s && s.value))
                l = Array.isArray(l) ? new Ie(new ge("", l)) : l.eval(e);
              else {
                if (!p[a].value)
                  throw {
                    type: "Runtime",
                ...
                ((l = p[a].value.eval(t)), f.resetCache());
              }
              (f.prependRule(new he(u, l)), (i[a] = l));
            }
          if (p[a].variadic && n)
    ...
    eval: function (e) {
      return new We(
        ...
        this.condition,
        this.variadic,
        this.frames || A(e.frames),
      );
    },
    evalCall: function (e, t, n) {
      var i,
        r,
        s = [],
        a = this.frames ? this.frames.concat(e.frames) : e.frames,
        o = this.evalParams(e, new B.Eval(e, a), t, s);
      return (
        o.prependRule(new he("@arguments", new we(s).eval(e))),
        (i = A(this.rules)),
        ((r = new ge(null, i)).originalRuleset = this),
        (r = r.eval(new B.Eval(e, [this, o].concat(a)))),
        n && (r = r.makeImportant()),
        r
      );
    },
    ...
    matchArgs: function (e, t) {
      ...
      n = Math.min(s, this.arity);
      for (var a = 0; a < n; a++)
        if (
          !this.params[a].name &&
          !this.params[a].variadic &&
          e[a].value.eval(t).toCSS() != this.params[a].value.eval(t).toCSS()
        )
          return !1;
      return !0;
    },
  ...
  Je.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      function x(t, n) {
        var i, r, s;
        for (i = 0; i < 2; i++) {
          for (w[i] = !0, me.value(i), r = 0; r < n.length && w[i]; r++)
            (s = n[r]).matchCondition &&
              (w[i] = w[i] && s.matchCondition(null, e));
          t.matchCondition && (w[i] = w[i] && t.matchCondition(m, e));
        }
        return w[0] || w[1] ? (w[0] != w[1] ? (w[1] ? 1 : 2) : 0) : -1;
      }
      for (
        this.selector = this.selector.eval(e), a = 0;
        a < this.arguments.length;
        a++
      )
        if (
          ((s = (r = this.arguments[a]).value.eval(e)),
          r.expand && Array.isArray(s.value))
        )
          for (s = s.value, o = 0; o < s.length; o++) m.push({ value: s[o] });
      ...
      for (
        ...
        if ((t = e.frames[a].find(this.selector, null, d)).length > 0) {
          for (c = !0, o = 0; o < t.length; o++) {
            for (
              n = t[o].rule, i = t[o].path, u = !1, l = 0;
              l < e.frames.length;
              l++
            )
              if (
          ...
          for (me.reset(), p = [0, 0, 0], o = 0; o < b.length; o++)
            p[b[o].group]++;
          if (p[0] > 0) f = 2;
          ...
          for (o = 0; o < b.length; o++)
            if (0 === (h = b[o].group) || h === f)
              try {
                (n = b[o].mixin) instanceof We ||
      ...
      return (
        ...
        (e.prototype.pathDiff = function (e, t) {
          var n,
            ...
            r,
            s,
            a = this.extractUrlParts(e),
            o = this.extractUrlParts(t),
            l = "";
          if (a.hostPart !== o.hostPart) return "";
          for (
            i = Math.max(o.directories.length, a.directories.length), n = 0;
            n < i && o.directories[n] === a.directories[n];
            n++
          );
          for (
            s = o.directories.slice(n), r = a.directories.slice(n), n = 0;
            n < s.length - 1;
            n++
          )
            l += "../";
        ...
        (e.prototype.extractUrlParts = function (e, t) {
          var n,
            ...
            l = [];
          if (!s)
            throw new Error("Could not parse sheet href - '".concat(e, "'"));
          if (t && (!s[1] || s[2])) {
            if (!(i = t.match(r)))
              throw new Error("Could not parse page url - '".concat(t, "'"));
            ((s[1] = s[1] || i[1] || ""), s[2] || (s[3] = i[3] + s[3]));
          }
          if (s[3])
            for (
              o = s[3].replace(/\\/g, "/").split("/"), n = 0;
              n < o.length;
              n++
            )
              ".." === o[n] ? l.pop() : "." !== o[n] && l.push(o[n]);
          return (
            (a.hostPart = s[1]),
            (a.directories = l),
            (a.rawPath = (s[1] || "") + o.join("/")),
            (a.path = (s[1] || "") + l.join("/")),
            (a.filename = s[4]),
            (a.fileUrl = a.path + (s[4] || "")),
            (a.url = a.fileUrl + (s[5] || "")),
            a
          );
        }),
    ...
    Qe = (function () {
      ...
      return (
        (e.prototype.evalPlugin = function (e, t, n, i, r) {
          ...
          if (u && (a = l.get(u))) {
            if ((c = this.trySetOptions(a, u, h, i))) return c;
            try {
          ...
          ((o = { exports: {}, pluginManager: l, fileInfo: r }),
            (s = ne.create()));
          try {
            new Function(
              "module",
          ...
          if (
            (a || (a = o.exports),
            (a = this.validatePlugin(a, u, h)) instanceof V)
          )
            return a;
          if (!a) return new V({ message: "Not a valid plugin" }, n, u);
          if (
            ((a.imports = n),
            (a.filename = u),
            (!a.minVersion || this.compareVersion("3.0.0", a.minVersion) < 0) &&
              (c = this.trySetOptions(a, u, h, i)))
          )
            return c;
          if (
            (l.addPlugin(a, r.filename, s),
            (a.functions = s.getLocalFunctions()),
            (c = this.trySetOptions(a, u, h, i)))
          )
            return c;
          try {
          ...
          return e
            ? ("function" == typeof e && (e = new e()),
              ...
              this.compareVersion(e.minVersion, this.less.version) < 0
                ? new V({
                    message: "Plugin "
                      .concat(n, " requires version ")
                      .concat(this.versionToString(e.minVersion)),
                  })
                : e)
            : null;
        }),
  ...
  function Ze(e, t, n, i) {
    return t.eval(e) ? n.eval(e) : i ? i.eval(e) : new se();
  }
  function Xe(e, t) {
    try {
      return (t.eval(e), ue.True);
    } catch (e) {
      return ue.False;
    }
  }
  ...
  var at = (Ye = {
    rgb: function (e, t, n) {
      ...
      if (e instanceof we) {
        var r = e.value;
        if (((e = r[0]), (t = r[1]), (n = r[2]) instanceof ke)) {
          var s = n;
          ((n = s.operands[0]), (i = s.operands[1]));
        }
      }
      var a = Ye.rgba(e, t, n, i);
      if (a) return ((a.value = "rgb"), a);
    },
    rgba: function (e, t, n, i) {
      try {
        if (e instanceof c)
          return ((i = t ? st(t) : e.alpha), new c(e.rgb, i, "rgba"));
        var r = [e, t, n].map(function (e) {
          return (
            (n = 255),
            (t = e) instanceof be && t.unit.is("%")
              ? parseFloat((t.value * n) / 100)
              : st(t)
          );
          var t, n;
        });
        return ((i = st(i)), new c(r, i, "rgba"));
      } catch (e) {}
    },
    hsl: function (e, t, n) {
      var i = 1;
      ...
      var a = Ye.hsla(e, t, n, i);
      if (a) return ((a.value = "hsl"), a);
    },
    hsla: function (e, t, n, i) {
      ...
      try {
        if (e instanceof c)
          return ((i = t ? st(t) : e.alpha), new c(e.rgb, i, "hsla"));
        ((e = (st(e) % 360) / 360),
          (t = tt(st(t))),
          (n = tt(st(n))),
          (i = tt(st(i))),
          (r = 2 * n - (s = n <= 0.5 ? n * (t + 1) : n + t - n * t)));
        var o = [255 * a(e + 1 / 3), 255 * a(e), 255 * a(e - 1 / 3)];
        return ((i = st(i)), new c(o, i, "hsla"));
      } catch (e) {}
    },
    hsv: function (e, t, n) {
    ...
    hsva: function (e, t, n, i) {
      ...
      var a = [
          n,
          n * (1 - t),
          n * (1 - (s = e / 60 - (r = Math.floor((e / 60) % 6))) * t),
          n * (1 - (1 - s) * t),
        ],
        o = [
          [0, 3, 1],
      ...
      return Ye.rgba(255 * a[o[r][0]], 255 * a[o[r][1]], 255 * a[o[r][2]], i);
    },
    hue: function (e) {
      return new be(it(e).h);
    },
    saturation: function (e) {
      return new be(100 * it(e).s, "%");
    },
    lightness: function (e) {
      return new be(100 * it(e).l, "%");
    },
    hsvhue: function (e) {
      return new be(rt(e).h);
    },
    hsvsaturation: function (e) {
      return new be(100 * rt(e).s, "%");
    },
    hsvvalue: function (e) {
      return new be(100 * rt(e).v, "%");
    },
    red: function (e) {
      return new be(e.rgb[0]);
    },
    green: function (e) {
      return new be(e.rgb[1]);
    },
    blue: function (e) {
      return new be(e.rgb[2]);
    },
    alpha: function (e) {
      return new be(it(e).a);
    },
    luma: function (e) {
      return new be(e.luma() * e.alpha * 100, "%");
    },
    ...
    fade: function (e, t) {
      var n = it(e);
      return ((n.a = t.value / 100), (n.a = tt(n.a)), nt(e, n));
    },
    spin: function (e, t) {
      var n = it(e),
        i = (n.h + t.value) % 360;
      return ((n.h = i < 0 ? 360 + i : i), nt(e, n));
    },
    mix: function (e, t, n) {
      n || (n = new be(50));
      var i = n.value / 100,
    ...
    greyscale: function (e) {
      return Ye.desaturate(e, new be(100));
    },
    contrast: function (e, t, n, i) {
      if (!e.rgb) return null;
      if (
        (void 0 === n && (n = Ye.rgba(255, 255, 255, 1)),
      ...
      return ((i = void 0 === i ? 0.43 : st(i)), e.luma() < i ? n : t);
    },
    argb: function (e) {
      return new se(e.toARGB());
    },
    color: function (e) {
      if (
        e instanceof Me &&
        ...
        return new c(t, void 0, "#".concat(t));
      }
  ...
  function ot(e, t, n) {
    ...
    s = l + o * (1 - l);
    for (var h = 0; h < 3; h++)
      ((a = e((i = t.rgb[h] / 255), (r = n.rgb[h] / 255))),
        s && (a = (l * r + o * (i - l * (i + r - a))) / s),
        (u[h] = 255 * a));
    return new c(u, s);
  }
  var lt = {
  ...
  for (var ut in lt) lt.hasOwnProperty(ut) && (ot[ut] = ot.bind(null, lt[ut]));
  var ct = function (e) {
    ...
    ht = {
      ...
      "~": function () {
        ...
        return 1 === e.length ? e[0] : new le(e);
      },
      extract: function (e, t) {
        return ((t = t.value - 1), ct(e)[t]);
      },
      length: function (e) {
        return new be(ct(e).length);
      },
      range: function (e, t, n) {
        var i,
          ...
          s = 1,
          a = [];
        t ? ((r = t), (i = e.value), n && (s = n.value)) : ((i = 1), (r = e));
        for (var o = i; o <= r.value; o += s) a.push(new be(o, r.unit));
        return new we(a);
      },
      each: function (e, t) {
        var n,
        ...
        for (var h = 0; h < i.length; h++) {
          ...
          (v instanceof he
            ...
            v instanceof de ||
              ((n = t.rules.slice(0)),
              o &&
                n.push(new he(o, p, !1, !1, this.index, this.currentFileInfo)),
              c &&
                n.push(
                  new he(
                    c,
              ...
              l &&
                n.push(new he(l, f, !1, !1, this.index, this.currentFileInfo)),
              s.push(
                new ge(
                  [new oe([new g("", "&")])],
                  n,
  ...
  var dt = function (e, t) {
      ...
      var h = [],
        f = {};
      for (n = 0; n < t.length; n++) {
        if (!((r = t[n]) instanceof be)) {
          if (Array.isArray(t[n].value)) {
                ...
                "" ===
                  (s =
                    "" === r.unit.toString() && void 0 !== u
                      ? new be(r.value, u).unify()
                      : r.unify()).unit.toString() && void 0 !== l
                  ? l
                  : s.unit.toString()) &&
              void 0 === l) ||
            ("" !== o && "" === h[0].unify().unit.toString())
              ? o
              : l),
          (u = "" !== o && void 0 === u ? r.unit.toString() : u),
          void 0 !==
            (i = void 0 !== f[""] && "" !== o && o === l ? f[""] : f[o]))
        )
          ((a =
            "" === h[i].unit.toString() && void 0 !== u
              ? new be(h[i].value, u).unify()
              : h[i].unify()),
            ((e && s.value < a.value) || (!e && s.value > a.value)) &&
              (h[i] = r));
        else {
          if (void 0 !== l && o !== l)
            throw { type: "Argument", message: "incompatible types" };
          ((f[o] = h.length), h.push(r));
        }
      }
      return 1 == h.length
        ? h[0]
        : ((t = h
          ...
          new se("".concat(e ? "min" : "max", "(").concat(t, ")")));
    },
    mt = {
      min: function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
      ...
      pi: function () {
        return new be(Math.PI);
      },
      mod: function (e, t) {
        return new be(e.value % t.value, e.unit);
      },
      pow: function (e, t) {
        if ("number" == typeof e && "number" == typeof t)
          ((e = new be(e)), (t = new be(t)));
        else if (!(e instanceof be && t instanceof be))
          throw { type: "Argument", message: "arguments must be numbers" };
        return new be(Math.pow(e.value, t.value), e.unit);
      },
    ...
    gt = {
      e: function (e) {
        return new Me('"', e instanceof Le ? e.evaluated : e.value, !0);
      },
      escape: function (e) {
        return new se(
          encodeURI(e.value)
      ...
      "%": function (e) {
        ...
        return (
          (n = n.replace(/%%/g, "%")),
          new Me(e.quote || "", n, e.escaped)
        );
      },
    },
    yt = function (e, t) {
      return e instanceof t ? ue.True : ue.False;
    },
    bt = function (e, t) {
      if (void 0 === t)
        throw {
      ...
      return e instanceof be && e.unit.is(t) ? ue.True : ue.False;
    },
    wt = {
        ...
        if (!(e instanceof be))
          throw {
            ...
            message: "the first argument to unit must be a number".concat(
              e instanceof ke ? ". Have you forgotten parenthesis?" : "",
            ),
          };
        return (
          (t = t ? (t instanceof ue ? t.value : t.toCSS()) : ""),
          new be(e.value, t)
        );
      },
      "get-unit": function (e) {
        return new se(e.unit);
      },
    },
    xt = function (e) {
      var t = this;
      switch ((e = Array.prototype.slice.call(e)).length) {
        case 0:
          throw { type: "Argument", message: "one or more arguments required" };
      }
      return (
        (e = [
          new Pe(e[0].value, this.index, this.currentFileInfo).eval(
            this.context,
          ),
        ]
          .map(function (e) {
            return e.toCSS(t.context);
          })
          .join(this.context.compress ? "," : ", ")),
        new Pe("style(".concat(e, ")"))
      );
    },
    St = {
      style: function () {
    ...
    It = function (e) {
      var t = { functionRegistry: ne, functionCaller: Ae };
      return (
        ne.addMultiple(et),
        ne.add("default", me.eval.bind(me)),
        ne.addMultiple(at),
        ne.addMultiple(ot),
        ne.addMultiple(
          (function (e) {
            var t = function (e, t) {
              return new Oe(t, e.index, e.currentFileInfo).eval(e.context);
            };
            return {
              "data-uri": function (n, i) {
                ...
                var s = n && n.value,
                  ...
                  l = o.rewriteUrls ? o.currentDirectory : o.entryPath,
                  u = a.indexOf("#"),
                  c = "";
                -1 !== u && ((c = a.slice(u)), (a = a.slice(0, u)));
                var h = _(this.context);
                h.rawBuffer = !0;
                var f = e.getFileManager(a, l, h, e, !0);
                if (!f) return t(this, i);
                var p = !1;
                if (n) p = /;base64$/.test(s);
                else {
                  if ("image/svg+xml" === (s = e.mimeLookup(a))) p = !1;
                  else {
                ...
                var m = d.contents;
                if (p && !e.encodeBase64) return t(this, i);
                m = p ? e.encodeBase64(m) : encodeURIComponent(m);
                var g = "data:".concat(s, ",").concat(m).concat(c);
                return new Oe(
                  new Me(
                    '"'.concat(g, '"'),
                    g,
        ...
        ne.addMultiple({
          "svg-gradient": function (e) {
            ...
            for (
              i = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"><'
                .concat(u, 'Gradient id="g" ')
                .concat(n, ">"),
                r = 0;
              r < t.length;
              r += 1
              ...
              (t[r] instanceof we
                ? ((s = t[r].value[0]), (a = t[r].value[1]))
                : ((s = t[r]), (a = void 0)),
                (s instanceof c &&
                  (((0 === r || r + 1 === t.length) && void 0 === a) ||
                    a instanceof be)) ||
                  v(),
                (o = a ? a.toCSS(f) : 0 === r ? "0%" : "100%"),
                (l = s.alpha),
                (i += '<stop offset="'
                  .concat(o, '" stop-color="')
                  .concat(s.toRGB(), '"')
                  .concat(
                    l < 1 ? ' stop-opacity="'.concat(l, '"') : "",
                    "/>",
                  )));
            return (
              (i += "</"
                .concat(u, "Gradient><rect ")
                .concat(h, ' fill="url(#g)" /></svg>')),
              (i = encodeURIComponent(i)),
              (i = "data:image/svg+xml,".concat(i)),
              new Oe(
                new Me(
                  "'".concat(i, "'"),
                  i,
      ...
      ((i = Object.keys(i).map(function (e) {
        ...
        return (
          t instanceof He.Value ||
            ...
            (t = new He.Value([t]))),
          new He.Declaration("@".concat(e), t, !1, null, 0)
        );
      })),
      (r.frames = [new He.Ruleset(null, i)]));
    var s,
      a,
      o = [
        new ee.JoinSelectorVisitor(),
        new ee.MarkVisibleSelectorsVisitor(!0),
        new ee.ExtendVisitor(),
        new ee.ToCSSVisitor({ compress: Boolean(t.compress) }),
      ],
      l = [];
    if (t.pluginManager) {
      a = t.pluginManager.visitor();
      for (var u = 0; u < 2; u++)
        for (a.first(); (s = a.get()); )
          s.isPreEvalVisitor
            ? (0 !== u && -1 !== l.indexOf(s)) || (l.push(s), s.run(e))
            : (0 !== u && -1 !== o.indexOf(s)) ||
              (s.isPreVisitor ? o.unshift(s) : o.push(s));
    }
    n = e.eval(r);
    for (var c = 0; c < o.length; c++) o[c].run(n);
    if (t.pluginManager)
      for (a.first(); (s = a.get()); )
        -1 === o.indexOf(s) && -1 === l.indexOf(s) && s.run(n);
    return n;
  }
  var kt,
    At = (function () {
        ...
        return (
          (t.prototype.toCSS = function (t) {
            ...
            try {
              ...
              t.sourceMap
                ? ((i = new e(t.sourceMap)),
                  (s.css = i.toCSS(n, o, this.imports)))
                : (s.css = n.toCSS(o));
            } catch (e) {
              throw new V(e, this.imports);
            }
            ...
            for (var c in (t.sourceMap && (s.map = i.getExternalSourceMap()),
            (s.imports = []),
            this.imports.files))
          ...
          return (
            ...
            (n.prototype.getCSSAppendage = function () {
              ...
              if (this.options.sourceMapFileInline) {
                ...
                e = "data:application/json;base64,".concat(
          ...
          return (
            (t.prototype.push = function (t, n, i, s, a) {
              ...
              var u = function (e, n, i) {
                ...
                h = e.getFileManager(t, i.currentDirectory, this.context, e);
              if (h) {
                var f,
                  p,
                  v = function (e) {
                    ...
                    ((c.currentDirectory = h.getPath(n)),
                      c.rewriteUrls &&
                        ((c.rootpath = h.join(
                          o.context.rootpath || "",
                      ...
                      (c.filename = n));
                    var a = new B.Parse(o.context);
                    ((a.processImports = !1),
                      (o.contents[n] = r),
                      (i.reference || s.reference) && (c.reference = !0),
                      s.isPlugin
                        ? (t = l.evalPlugin(
                            r,
                            a,
                        ...
                        : s.inline
                          ? u(null, r, n)
                          : !o.files[n] ||
                              o.files[n].options.multiple ||
                              s.multiple
                            ? new ae(a, o, c).parse(r, function (e, t) {
                                u(e, t, n);
                              })
                            : u(null, o.files[n].root, n));
                  },
                  d = _(this.context);
                (n && (d.ext = s.isPlugin ? ".js" : ".less"),
                  s.isPlugin
                    ? ((d.mime = "application/javascript"),
                      d.syncImport
                        ? (f = l.loadPluginSync(t, i.currentDirectory, d, e, h))
                        : (p = l.loadPlugin(t, i.currentDirectory, d, e, h)))
                    : d.syncImport
                      ? (f = h.loadFileSync(t, i.currentDirectory, d, e))
                      : (p = h.loadFile(
                          t,
                          i.currentDirectory,
                          d,
                ...
                u({ message: "Could not find a file-manager for ".concat(t) });
            }),
            t
          );
        })();
    ...
    var u,
      c = (function (e, t) {
        var n = function (e, i, r) {
          if (
            ("function" == typeof i
              ? ((r = i), (i = E(this.options, {})))
              : (i = E(this.options, i || {})),
            !r)
          ) {
            var s = this;
            return new Promise(function (t, r) {
              n.call(s, e, i, function (e, n) {
                e ? r(e) : t(n);
              });
            });
          }
          this.parse(e, i, function (e, n, i, s) {
            if (e) return r(e);
            var a;
            try {
              a = new t(n, i).toCSS(s);
      ...
      h = (function (e, t, n) {
        var i = function (e, t, r) {
          if (
            ("function" == typeof t
              ? ((r = t), (t = E(this.options, {})))
              : (t = E(this.options, t || {})),
            !r)
          ) {
            var s = this;
            return new Promise(function (n, r) {
              i.call(s, e, t, function (e, t) {
                e ? r(e) : n(t);
              });
            });
          }
          var a,
            o = void 0,
            l = new _t(this, !t.reUsePluginManager);
          if (((t.pluginManager = l), (a = new B.Parse(t)), t.rootFileInfo))
            o = t.rootFileInfo;
          else {
  ...
  var Ot = {},
    $t = function () {};
  $t.prototype = Object.assign(new Ke(), {
    ...
    doXHR: function (e, t, n, i) {
      var r = new XMLHttpRequest(),
        s = !Pt.isFileProtocol || Pt.fileAsync;
      function a(t, n, i) {
      ...
      ("function" == typeof r.overrideMimeType &&
        ...
        r.send(null),
        Pt.isFileProtocol && !Pt.fileAsync
          ? 0 === r.status || (r.status >= 200 && r.status < 300)
            ? n(r.responseText)
            : i(r.status, e)
          : s
            ? (r.onreadystatechange = function () {
                4 == r.readyState && a(r, n, i);
              })
            : a(r, n, i));
    },
    supports: function () {
    ...
    loadFile: function (e, t, n) {
      (t && !this.isPathAbsolute(e) && (e = t + e),
        ...
        (n = n || {}));
      var i = this.extractUrlParts(e, window.location.href).url,
        r = this;
      return new Promise(function (e, t) {
        if (n.useFileCache && Ot[i])
          try {
            var s = Ot[i];
            return e({
              contents: s,
        ...
        r.doXHR(
          ...
          function (t, n) {
            ((Ot[i] = t),
              e({ contents: t, filename: i, webInfo: { lastModified: n } }));
          },
          function (e, n) {
            t({
              type: "File",
  ...
  Ft.prototype = Object.assign(new Qe(), {
    loadPlugin: function (e, t, n, i, r) {
      return new Promise(function (s, a) {
        r.loadFile(e, t, n, i).then(s).catch(a);
      });
    },
  });
      ...
      return {
          ...
          r.errorReporting && "html" !== r.errorReporting
            ? "console" === r.errorReporting
              ...
              : "function" == typeof r.errorReporting &&
                r.errorReporting("add", s, a)
            : (function (i, s) {
                var a,
                  o,
                  l = "less-error-message:".concat(e(s || "")),
                ...
                ((u.id = l),
                  ...
                  (o =
                    "<h3>"
                      .concat(i.type || "Syntax", "Error: ")
                      .concat(
                        i.message || "There is an error in your .less file",
                      ) +
                    '</h3><p>in <a href="'.concat(h, '">').concat(f, "</a> ")));
                ...
                (i.line &&
                  ...
                  p(i, 2, ""),
                  (o += "on line "
                    .concat(i.line, ", column ")
                    .concat(i.column + 1, ":</p><ul>")
                    .concat(c.join(""), "</ul>"))),
                  i.stack &&
                    (i.extract || r.logLevel >= 4) &&
                    (o += "<br/>Stack Trace</br />".concat(
                      i.stack.split("\n").slice(1).join("<br/>"),
                    )),
                  (u.innerHTML = o),
                  n(
        ...
        remove: function (n) {
          r.errorReporting && "html" !== r.errorReporting
            ...
            : (function (n) {
                var i = t.document.getElementById(
                  "less-error-message:".concat(e(n)),
                );
  ...
  if (window.less)
    for (var Dt in window.less)
      Object.prototype.hasOwnProperty.call(window.less, Dt) &&
        (jt[Dt] = window.less[Dt]);
  (!(function (e, n) {
    (t(n, i(e)),
    ...
    (jt.plugins = jt.plugins || []),
    window.LESS_PLUGINS &&
      (jt.plugins = jt.plugins.concat(window.LESS_PLUGINS)));
  var Nt,
    Bt,
    Ut,
    qt = (function (e, i) {
            ...
            return {
              setCSS: function (e, t, r, s) {
                if (i) {
                  ...
                  try {
                    (i.setItem(e, s),
                      i.setItem("".concat(e, ":timestamp"), t),
                      r && i.setItem("".concat(e, ":vars"), JSON.stringify(r)));
                  } catch (t) {
                    n.error(
              ...
              getCSS: function (e, t, n) {
                var r = i && i.getItem(e),
                  s = i && i.getItem("".concat(e, ":timestamp")),
                  a = i && i.getItem("".concat(e, ":vars"));
                if (
                  ((n = n || {}),
                  (a = a || "{}"),
                  s &&
      ...
      (!(function () {
        ...
        i.functions && s.functions.functionRegistry.addMultiple(i.functions));
      var h = /^text\/(x-)?less$/;
      function f(e) {
        var t = {};
        for (var n in e)
      ...
      function v(e) {
        for (
          var t, n = r.getElementsByTagName("style"), a = 0;
          a < n.length;
          a++
        )
          if ((t = n[a]).type.match(h)) {
            var o = f(i);
            o.modifyVars = e;
            var l = t.innerHTML || "";
            ((o.filename = r.location.href.replace(/#.*$/, "")),
              s.render(
                l,
                o,
                p(
            ...
            .then(function (t) {
              !(function (t) {
                ...
                if (
                  ...
                  h.remaining = o;
                  var v = c.getCSS(a, h, p.modifyVars);
                  if (!r && v)
                    return ((h.local = !0), void n(null, v, i, e, h, a));
                }
                (u.remove(a),
                  (p.rootFileInfo = f),
                  s.render(i, p, function (t, r) {
                    t
                      ? ((t.href = a), n(t))
                      : (c.setCSS(e.href, h.lastModified, p.modifyVars, r.css),
                        n(null, r.css, i, e, h, a));
                  }));
              })(t);
            })
            .catch(function (e) {
      ...
      function m(e, t, n) {
        for (var i = 0; i < s.sheets.length; i++)
          d(s.sheets[i], e, t, s.sheets.length - (i + 1), n);
      }
      return (
        (s.watch = function () {
          return (
            s.watchMode ||
              ...
              "development" === s.env &&
                (s.watchTimer = setInterval(function () {
                  s.watchMode &&
                    (l.clearFileCache(),
                    m(function (t, i, r, s, a) {
                      t ? u.add(t, t.href || s.href) : i && n(e.document, i, s);
                    }));
                }, i.poll))),
            (this.watchMode = !0),
            !0
            ...
            new Promise(function (r, a) {
              ...
              ((o = l = new Date()),
                0 === (h = s.sheets.length)
                  ...
                  : m(
                      function (t, i, f, p, v) {
                        if (t) return (u.add(t, t.href || p.href), void a(t));
                        (v.local
                          ? s.logger.info(
                              "Loading ".concat(p.href, " from cache."),
                            )
                          : s.logger.info(
                              "Rendered ".concat(p.href, " successfully."),
                            ),
                          n(e.document, i, p),
                          s.logger.info(
                            "CSS for "
                              .concat(p.href, " generated in ")
                              .concat(new Date() - l, "ms"),
                          ),
                          0 === --h &&
                            ((c = new Date() - o),
                            s.logger.info(
                              "Less has finished. CSS generated in ".concat(
                                c,
                                "ms",
                              ),
                            ),
  ...
  function Tt(e) {
    (e.filename && console.warn(e), jt.async || Bt.removeChild(Ut));
  }
  return (
    (window.less = qt),
    jt.onReady &&
      (/!watch/.test(window.location.hash) && qt.watch(),
      jt.async ||
        ((Nt = "body { display: none !important }"),
        (Bt = document.head || document.getElementsByTagName("head")[0]),
        ((Ut = document.createElement("style")).type = "text/css"),
        Ut.styleSheet
          ? (Ut.styleSheet.cssText = Nt)
          : Ut.appendChild(document.createTextNode(Nt)),
        Bt.appendChild(Ut)),
      qt.registerStylesheetsImmediately(),
      (qt.pageLoadFinished = qt
        .refresh("development" === qt.env)
        .then(Tt, Tt))),
    qt
  );
});
